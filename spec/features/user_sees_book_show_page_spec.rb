...
describe 'book show page' do
  before (:each) do
    ...
    @book.reviews.create(title: "Awesome book!", description: "This book is super great!", rating: 5, user_id: user.id)
    @book.reviews.create(title: "Uh...", description: "I don't get it.", rating: 5, user_id: user.id)
